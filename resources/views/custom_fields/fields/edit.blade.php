         ...
         <div class="form-group">
          ...
          @endif
             ...
             <div class="col-md-9 col-md-offset-3" id="show_custom_field_on_audit">
                 <label class="form-control">
                     <input type="checkbox" name="show_custom_field_on_audit" aria-label="show_custom_field_on_audit" value="1" {{ (old('show_custom_field_on_audit') || $field->show_custom_field_on_audit) ? ' checked="checked"' : '' }}>
