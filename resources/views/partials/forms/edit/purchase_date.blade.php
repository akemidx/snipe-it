...
<div class="form-group {{ $errors->has('purchase_date') ? ' has-error' : '' }}">
   ...
   <div class="input-group col-md-4">
        <div class="input-group date" id="purchase_date_wrapper" data-date-clear-btn="true" data-date-format="yyyy-mm-dd"  data-autoclose="true">
            {{--TODO: instantiation of the purchase has been moved to livewire, so we should check where else we use this. --}}
